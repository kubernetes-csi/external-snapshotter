...
// Note: Do not remove the following replace clause as it is needed to generate changelog
replace (
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.0.0
	k8s.io/kms => k8s.io/kms v0.0.0
