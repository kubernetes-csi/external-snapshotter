...
func TestDeleteSync(t *testing.T) {
	...
	tests := []controllerTest{
		...
		},
		{
			...
			expectedListCalls:   []listCall{{"sid1-2", true, time.Now(), 1, map[string]string{}, nil}},
		...
		},
		{
			...
			expectedListCalls:   []listCall{{"sid1-3", true, time.Now(), 1, map[string]string{}, nil}},
			test:                testSyncContent,
		},
		{
		...
		},
		{
			...
			expectedListCalls:   []listCall{{"sid1-5", true, time.Now(), 1000, map[string]string{}, nil}},
		...
		},
		{
			...
			expectedListCalls:   []listCall{{"sid1-6", false, time.Now(), 0, nil, nil}},
		...
		},
		{
			...
			expectedEvents:    noevents,
			expectedListCalls: []listCall{{"sid1-7", true, time.Now(), 1000, map[string]string{}, nil}},
			initialSecrets:    []*v1.Secret{secret()},
			errors:            noerrors,
			test:              testSyncContent,
		},
		{
			...
			expectedEvents:    noevents,
			expectedListCalls: []listCall{{"sid1-8", true, time.Now(), 0, map[string]string{}, nil}},
			errors:            noerrors,
			test:              testSyncContent,
		},
		{
			...
			expectedEvents:      noevents,
			expectedListCalls:   []listCall{{"sid1-9", true, time.Now(), 0, map[string]string{}, nil}},
			errors:              noerrors,
		...
		},
		{
			...
			expectedEvents:    noevents,
			expectedListCalls: []listCall{{"sid1-10", true, time.Now(), 0, map[string]string{}, nil}},
			errors:            noerrors,
		...
		},
		{
			...
			expectedEvents:    noevents,
			expectedListCalls: []listCall{{"sid1-12", true, time.Now(), 0, map[string]string{}, nil}},
			errors:            noerrors,
			initialSecrets:    []*v1.Secret{},
			test:              testSyncContent,
		},
