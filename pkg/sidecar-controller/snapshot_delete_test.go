...
func TestDeleteSync(t *testing.T) {
	tests := []controllerTest{
		...
		},
		{
			...
			expectedEvents:      []string{"Warning SnapshotDeleteError Failed to delete snapshot: failed to delete snapshot content content1-3: \"mock csi driver delete error\""},
		...
		},
		{
			...
			expectedEvents:      []string{"Warning SnapshotDeleteError Failed to delete snapshot: failed to delete snapshot content content1-5: \"mock csi driver delete error\""},
			errors:              noerrors,
			test:                testSyncContent,
		},
		{
