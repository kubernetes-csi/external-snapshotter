...
func TestSync(t *testing.T) {
	tests := []controllerTest{
		...
		},
		{
			...
			initialContents:   newContentArray("content2-2", "sid2-2", "snapuid2-2-x", "snap2-2", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content2-2", "sid2-2", "snapuid2-2-x", "snap2-2", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content2-3", "sid2-3", "", "snap2-3", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content2-3", "sid2-3", "snapuid2-3", "snap2-3", &deletePolicy, nil, nil, false),
		...
		},
		{
			// nothing changed
			name:              "2-4 - noop",
			initialContents:   newContentArray("content2-4", "sid2-4", "snapuid2-4", "snap2-4", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content2-4", "sid2-4", "snapuid2-4", "snap2-4", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content2-5", "sid2-5", "snapuid2-5", "snap2-5", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content2-5", "sid2-5", "snapuid2-5", "snap2-5", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content2-6", "sid2-6", noBoundUID, "snap2-6", &deletePolicy, nil, &timeNowStamp, false),
			expectedContents:  newContentArray("content2-6", "sid2-6", "snapuid2-6", "snap2-6", &deletePolicy, nil, &timeNowStamp, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content2-7", "sid2-7", "snapuid2-7", "snap2-7", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content2-7", "sid2-7", "snapuid2-7", "snap2-7", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content2-8", "sid2-8", "snapuid2-8", "snap2-8", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content2-8", "sid2-8", "snapuid2-8", "snap2-8", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content2-9", "sid2-9", "snapuid2-9", "snap2-9", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content2-9", "sid2-9", "snapuid2-9", "snap2-9", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content2-10", "sid2-10", "snapuid2-10-x", "snap2-10", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content2-10", "sid2-10", "snapuid2-10-x", "snap2-10", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content3-3", "sid3-3", "snapuid3-3", "snap3-3", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content3-3", "sid3-3", "snapuid3-3", "snap3-3", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentArray("content3-4", "sid3-4", "snapuid3-4-x", "snap3-4", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content3-4", "sid3-4", "snapuid3-4-x", "snap3-4", &deletePolicy, nil, nil, false),
		...
		},
		{
			...
			initialContents:   newContentWithUnmatchDriverArray("content3-5", "sid3-5", "", "snap3-5", &deletePolicy, nil, nil),
			expectedContents:  nocontents,
		...
		},
		{
			...
			initialContents:   newContentArray("content3-4", "sid3-4", "snapuid3-4-x", "snap3-6", &deletePolicy, nil, nil, false),
			expectedContents:  newContentArray("content3-4", "sid3-4", "snapuid3-4-x", "snap3-6", &deletePolicy, nil, nil, false),
			initialSnapshots:  newSnapshotArray("snap3-5", validSecretClass, "content3-5", "snapuid3-5", "claim3-5", false, nil, nil, nil),
			expectedSnapshots: newSnapshotArray("snap3-5", validSecretClass, "content3-5", "snapuid3-5", "claim3-5", false, newVolumeError("VolumeSnapshotContent is missing"), nil, nil),
			expectedEvents:    []string{"Warning SnapshotContentMissing"},
			errors:            noerrors,
