...
func TestSync(t *testing.T) {
	...
	tests := []controllerTest{
		...
		{
			name:              "2-10 - (static) do not bind content donest not point to the snapshot",
		...
		},
		{
			...
			expectedSnapshots: newSnapshotArray("snap2-13", "snapuid2-13", "claim2-13", "", validSecretClass, "", &False, metaTimeNow, nil, newVolumeError("VolumeSnapshotContent is pre-provisioned while expecting a dynamically provisioned one"), false, true, nil),
